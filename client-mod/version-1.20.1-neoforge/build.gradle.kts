...
// NeoForge 1.20.1 与 Forge API 完全兼容(net.minecraftforge 包名),复用 forge 入口与 mods.toml
sourceSets.main {
    java.srcDir(rootProject.file("version-1.20.1/src/main/java"))
    ...
    resources.srcDir(rootProject.file("version-1.20.1/src/main/resources"))
}
