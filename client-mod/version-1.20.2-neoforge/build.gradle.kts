...
sourceSets.main {
    java.srcDir(rootProject.file("version-1.20.2/src/main/java"))
    ...
    resources.srcDir(rootProject.file("shared/neoforge/resources-toml-legacy"))
    resources.srcDir(rootProject.file("version-1.20.2/src/main/resources"))
}
