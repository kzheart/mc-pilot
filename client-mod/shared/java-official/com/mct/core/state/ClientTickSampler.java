 ...
 *
 * 通过 Mixin 在 MinecraftClient#tick 的 TAIL 调用 {@link #sample(Minecraft)}。
 */
public final class ClientTickSampler {
    ...
    public void sample(Minecraft client) {
        ...
        boolean dead = player.isDeadOrDying() || health <= 0f;
    ...
    private static Map<String, Object> positionPayload(LocalPlayer player) {
