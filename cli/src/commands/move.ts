...
export function createMoveCommand() {
  ...
  command
    .command("to")
    .description(
      "Move to coordinates (straight-line walk, may get stuck on obstacles; times out after 30s)",
    )
    ...
    .action(
      createRequestAction(
        ...
        (_payload, context) =>
          withTransportTimeoutBuffer(30, context.timeout("default")),
      ),
    );
      ...
      .action(
        createRequestAction(
          ...
          ({ args }, context) => {
            ...
            return withTransportTimeoutBuffer(
              timeout,
