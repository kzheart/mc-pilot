...
"$MCT_BIN" client launch player1 --server 127.0.0.1:25565 --account Fighter1 --ws-port 25560
"$MCT_BIN" client launch player2 --server 127.0.0.1:25565 --account Fighter2 --ws-port 25561
